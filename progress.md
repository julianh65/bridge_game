...
## Active tasks
- owner: agent4
  scope: refactor card-effects economy/hand effect handlers into module
  files: packages/engine/src/card-effects.ts, packages/engine/src/card-effects-economy.ts, implementation_plan.md, progress.md
  status: in progress
