...
## Active tasks
- owner: agent4
  scope: refactor GameScreen info dock (log/effects) into dedicated component
  files: apps/web/src/components/GameScreen.tsx, apps/web/src/components/GameScreenInfoDock.tsx, implementation_plan.md, progress.md
  status: in progress
## Planning updates
