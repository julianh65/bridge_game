...
- Added a bottom-of-round cumulative hits summary row to the combat overlay; marked the plan checklist item complete. (Files: `apps/web/src/components/CombatOverlay.tsx`, `apps/web/src/styles.css`, `implementation_plan.md`.)
...
- Added Insight card-effect test for draw 2 and updated the plan checklist. (Files: `packages/engine/src/card-effects.insight.test.ts`, `implementation_plan.md`.) (Test: `npm run -w @bridgefront/engine test -- card-effects.insight.test.ts`.) (owner: agent2)
