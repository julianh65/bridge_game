...
- Added Spoils of War card-effect test for battle-win gold and updated the plan checklist. (Files: `packages/engine/src/card-effects.combat-modifiers.test.ts`, `implementation_plan.md`.) (Test: not run.) (owner: agent2)
